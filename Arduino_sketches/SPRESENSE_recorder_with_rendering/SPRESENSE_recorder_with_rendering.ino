...
// const int32_t sc_buffer_size = 24576; // ERROR: FIFO area is not allcated.
const int32_t sc_buffer_size = 6144;
/* 12:21:27.267 -> Attention: module[6][0] attention id[1]/code[5] (objects/media_player/media_player_obj.cpp L867)

12:21:27.267 -> Attention!
12:21:27.698 -> Attention: module[4][0] attention id[1]/code[6] (objects/media_recorder/audio_recorder_sink.cpp L84)

12:21:27.698 -> Attention!! Level 0x1 Code 0x6
12:21:28.393 -> WARNING: Insufficient buffer area.
*/


uint8_t s_buffer[sc_buffer_size];
// int32_t s_buffer[sc_buffer_size];
...
theRecorder->init(AS_CODECTYPE_WAV, AS_CHANNEL_STEREO, AS_SAMPLINGRATE_48000, AS_BITLENGTH_16, AS_BITRATE_8000);
  ...
  s_myFile = theSD.open("rec_render.wav", FILE_WRITE);
