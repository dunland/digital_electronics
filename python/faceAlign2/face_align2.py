...
for folder in folders[1:]:
	path = path + "/" + folder
path_for_face = "data/haarcascade_frontalface_default.xml"
path_for_eyes = "data/haarcascade_eye.xml"
path_for_nose = "data/haarcascade_mcs_nose.xml"

assert os.path.exists("data/haarcascade_frontalface_default.xml"), os.getcwd()   #  if that assertion passes, the file exists... so failure to load probably indicates a corrupted file. if that assertion fails, you'll get a traceback saying so. that means the file doesn't exist and you should think about what path you are getting from getcwd()
...
test_set = ["/home/dunland/Pictures/jonas.jpeg"]
for i in test_set:
