...
public class processing_allPointsOfLine extends PApplet {
...
public PVector getCurveVertexPoint(PVector P0, PVector P1, PVector P2, PVector P3, float t) {
  float alpha = 0.5f;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "processing_allPointsOfLine" };
    if (passedArgs != null) {
